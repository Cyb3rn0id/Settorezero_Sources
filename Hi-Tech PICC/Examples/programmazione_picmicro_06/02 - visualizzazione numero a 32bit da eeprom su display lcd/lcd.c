/***********************************************************************
 POOR's (universal) LCD interface V1.4c           
...
LCD_PUTUN32(number)  ---> Writes an Unsigned Number on LCD.
                        It works both with LONG (32bit), SHORT LONG (24bit)
		     INT (16bit) and CHAR (8bit).
...
/****************************************
  Writes unsigned 32bit numbers to the LCD
*****************************************/
void LCD_PUTUN32 (unsigned long c)
	{
	unsigned char t1,i,wrote;
	unsigned long k;
	wrote=0;
