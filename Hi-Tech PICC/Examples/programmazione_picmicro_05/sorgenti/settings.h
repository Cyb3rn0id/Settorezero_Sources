...
// Variabili
unsigned char counter=77; // valore del contatore
unsigned char result=0; // variabile di appoggio per calcoli
unsigned char muxcount=0; // contatore multiplex
bit actdisplay=0; // flag che tiene conto del display correntemente visualizzato
...
void settings(void)
	...
	TRISD=0b00110000; // Porte D tutte uscita tranne 4 e 5 dove sono collegati i pulsanti
